...
# This is the original executable (moved from C:\\Windows\\system32\\)
...
# Get the PID of the "C:\\calc.exe"
pid = process_information.dwProcessId

# Flag parameter = 0 (Code injection), 1 (DLL injection)
# In case of DLL injection, data varable should contain the path to the DLL
...
# Pop the process kill shellcode in
