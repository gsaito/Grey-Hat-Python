...
class debugger():
	...
	def enumerate_threads(self):
		...
		if snapshot is not None:
			...
			# You have to set the size of struct or the call will fail
	...
	def exception_handler_breakpoint(self):
		...
		# check if the breakpoint is the one that we set
	...
	def exception_handler_single_step(self):
		...
		# Comment from PyDbg:
		# determine if this single step event occured in reaction to a
		...
		if self.context.Dr6 & 0x1 and self.hardware_breakpoints.has_key(0):
			...
			print "[*] DBG_EXCEPTION_NOT_HANDLED"
